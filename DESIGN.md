---
version: alpha
name: YuNi-design-system
description: |
  于你 (YuNi) — 治愈系 AI 陪伴应用。软粉渐变背景（#FFF0F3 → #FFF8F9），柔和粉强调色（#FF8DAC / #FF6B9B），白色高圆角卡片，温暖二次元风格。
  设计关键词：柔软、温暖、少女、治愈、二次元、包容。

colors:
  primary: "#FF8DAC"
  primary-strong: "#FF6B9B"
  primary-light: "#FFB8CC"
  primary-bg: "#FFF0F3"
  surface: "#FFF8F9"
  card: "#FFFFFF"
  ink: "#2D1B2E"
